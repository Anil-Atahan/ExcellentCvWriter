...
namespace Modules.Users.Persistence.Migrations
{
    ...
    [Migration("20240314214344_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExcellentCvWriter.SharedKernel.Persistence.Inbox.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ExcellentCvWriter.SharedKernel.Persistence.Inbox.InboxMessageConsumer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ExcellentCvWriter.SharedKernel.Persistence.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ExcellentCvWriter.SharedKernel.Persistence.Outbox.OutboxMessageConsumer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
